...
if args['csv_file'] is not None:
    ...
    utils.generate_dlib_xml(dict_csv,file_sizes['train'],folder=os.path.join(args['output_dir'], 'train'),out_file=os.path.join(args['output_dir'], 'train.xml'))
    utils.generate_dlib_xml(dict_csv,file_sizes['test'],folder=os.path.join(args['output_dir'], 'test'),out_file=os.path.join(args['output_dir'], 'test.xml'))
    
if args['tps_file'] is not None:
    dict_tps=utils.read_tps(args['tps_file'])
    utils.generate_dlib_xml(dict_tps,file_sizes['train'],folder=os.path.join(args['output_dir'], 'train'),out_file=os.path.join(args['output_dir'], 'train.xml'))
    utils.generate_dlib_xml(dict_tps,file_sizes['test'],folder=os.path.join(args['output_dir'], 'test'),out_file=os.path.join(args['output_dir'], 'test.xml'))
